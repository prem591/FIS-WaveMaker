                      ...
                      <div className="row">
                          <div className={clsx('col col--4', styles.pricing_table_col)}>
                              ...
                              <div className={styles.pricing_table_body}>
                                  ...
                                  <p className={styles.pricing_table_body_content}><img src="../../static/img/licencing/Icon-Wrong.svg" />Team Collaboration</p>
                                  ...
                                  <p className={styles.pricing_table_body_content}><img src="../../static/img/licencing/Icon-Right.svg" />Standard Support <span
                                      className={styles.tooltip}><img src="../../static/img/licencing/Icon-question.svg" /><span className={styles.tooltiptext}>Email and Chat support with 1 day SLA</span> </span></p>
